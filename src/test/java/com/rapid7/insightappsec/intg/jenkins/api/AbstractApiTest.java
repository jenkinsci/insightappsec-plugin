...
import static com.rapid7.insightappsec.intg.jenkins.api.search.PageModels.aMetadata;
import static com.rapid7.insightappsec.intg.jenkins.api.search.PageModels.aPageOf;
...
public class AbstractApiTest {
    ...
    private String expectedBody() {
        try {
            return OBJECT_MAPPER_INSTANCE.writeValueAsString(BODY);
